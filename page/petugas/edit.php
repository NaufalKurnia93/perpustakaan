                    ...
                    <div class="card-header text-center bg-primary text-white">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" name="nama_petugas" id="nama_petugas" value="<?php echo htmlspecialchars($nama_petugas); ?>" placeholder="Masukkan nama anda" class="form-control">
                            </div>

                            <div class="mb-2">
                           <label>Jenis Kelamin</label>
                                <select class="form-control" name="jenis_kelamin" id="jenis_kelamin" value="<?php echo htmlspecialchars($jenis_kelamin); ?>">
                            ...
                            <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" name="alamat" value="<?php echo htmlspecialchars($alamat); ?>"placeholder="Masukkan alamat" class="form-control">
                            </div>

                            <div class=" mb-2">
                              <label>Jabatan</label>
                                <select class="form-control" name="jabatan" value="<?php echo htmlspecialchars($jabatan); ?>">
                        ...
                        <div class="mb-2">
                           <label>Shift</label>
                                <select class="form-control" name="shift" value="<?php echo htmlspecialchars($shift); ?>">
                                <option>pagi</option>
                                <option>siang</option>
                                <option>sore</option>
                            </select>
