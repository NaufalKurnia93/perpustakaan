...
<body>
  <div class="container mt-5">
    <div class="card">
      ...
      <a href="index.php?page=petugas&act=create" class="btn btn-md btn-info ml-3" style="margin-bottom: 16px">TAMBAH DATA</a>
                  ...
                  require_once 'database/class/petugas.php';
                      ...
                      $no=1;
                        ...
                        <td class="text-center">
                          <a href="index.php?page=petugas&act=update&id_petugas=<?php echo $row['id_petugas'] ?>" class="btn btn-info btn-sm">Edit</a>

                          <a href="index.php?page=petugas&act=delete&id_petugas=<?php echo $row['id_petugas'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Perhatian! Data Anda akan segera dihapus. Pastikan semua informasi penting telah dicadangkan.?')">Hapus</a>
