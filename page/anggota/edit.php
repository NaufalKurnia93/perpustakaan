            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                         <input name="nama_anggota" type="text" class="form-control" placeholder="Masukkan Nama Lengkap" required value="<?php echo htmlspecialchars($nama_anggota); ?>">
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_telpon"value="<?php echo htmlspecialchars($no_telpon); ?>"placeholder="Masukkan nomor handphone" class="form-control">
                            </div>
