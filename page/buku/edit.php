            ...
            <div class="card-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  <label>Judul</label>
                  <input type="text" name="judul" value="<?php echo $judul; ?>" placeholder="Masukkan nama buku" class="form-control">
                ...
                <div class="form-group mb-2">
                  ...
                  <input type="text" name="penerbit" value="<?php echo $penerbit; ?>" placeholder="Masukkan penerbit buku" class="form-control">
                </div>

                <div class="form-group">
                  <label>Tahun Terbit</label>
                  <input type="number" name="tahun_terbit" value="<?php echo $tahun_terbit; ?>" placeholder="Masukkan tahun terbit" class="form-control">
                </div>
