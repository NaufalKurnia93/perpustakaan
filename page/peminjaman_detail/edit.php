            ...
            <div class="card-body">
              <form action="" method="POST">
                ...
                <div class="form-group mb-2">
                  ...
                  <input type="date" name="tanggal_pinjam" value="<?php echo $tanggal_pinjam; ?>" placeholder="Masukkan tanggal pinjam" class="form-control">
                </div>

                <div class="form-group">
                  <label>Tanggal Kembali</label>
                  <input type="date" name="tanggal_kembali" value="<?php echo $tanggal_kembali; ?>" placeholder="Masukkan tanggal_kembali" class="form-control">
                </div>
