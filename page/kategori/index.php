...
<body>
  <div class="container mt-5">
    <div class="card">
      ...
      <a href="index.php?page=kategori&act=create" class="btn btn-md btn-info ml-3" style="margin-bottom: 16px">TAMBAH DATA</a>
                  ...
                  require_once 'database/class/kategori.php';
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['nama_kategori'] ?></td>
                          ...
                          <a href="index.php?page=kategori&act=delete&id_kategori=<?php echo $row['id_kategori'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Perhatian! Data Anda akan segera dihapus. Pastikan semua informasi penting telah dicadangkan.?')">Hapus</a>
                        </td>
                    </tr>
                 <?php
                }
